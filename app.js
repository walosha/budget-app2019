...
var uiContoller = (function() {
    ...
    return { 
            ...
            displayBudget: function(obj){
                ...
                document.querySelector(domStrings.budgetLabel).textContent= obj.budgetLabel;
...
var setUpEventsListners = function () {
    ...
    document.querySelector(dom.addButton).addEventListener("click",contrlAddItem);
...
var contrlAddItem = function(){
    ...
    var input, newItems;
        ...
        newItems = budgetContoller.addNewItems(input.type, input.description, input.value);
